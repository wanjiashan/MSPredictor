...
from MSPredictor import *
from torch.autograd import Variable


def TrainMSPredictor(train_dataloader, valid_dataloader, A, K=3, num_epochs=100, mamba_features=883):
...
def TestMSPredictor(kfgn_mamba, test_dataloader, max_speed):
    use_gpu = torch.cuda.is_available()
    loss_MSE = torch.nn.MSELoss()
    losses_mse = []
    losses_l1 = []
